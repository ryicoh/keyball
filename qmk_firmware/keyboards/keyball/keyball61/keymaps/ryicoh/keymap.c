...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BS] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_GRV   , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B ,                   KC_B  , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , MO(_FN)  ,
    KC_ESC   , KC_LNG4  , KC_LNG1  , KC_LOPT  , KC_LCMD  , KC_SPC   , KC_BTN1 ,             KC_BSPC  , KC_ENT   , _______  , _______  , _______  , KC_RBRC  , KC_BSLS
  ),
  [_FN] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , MO(_SET)
  ),
