...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BS] = LAYOUT_universal(
    ...
    KC_BSPC  , KC_LNG2  , KC_LNG1  , KC_LOPT  , KC_LCMD  , KC_SPC   , KC_BTN1 ,             KC_BSLS  , KC_ENT   , _______  , _______  , _______  , KC_LBRC  , KC_RBRC  ,
  ),
  [_FN] = LAYOUT_universal(
    _______  , KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    , KC_F6    ,                                  KC_F7    , KC_F8    , KC_F9    , KC_F10   , MO(_SET) ,
